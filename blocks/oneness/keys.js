...
Blockly.Blocks['keys_config_get'] = {
  init: function() {
    var TYPES =  [
          ['String', 'String'],
          ['Long', 'Long'],
    ...
    this.appendDummyInput()
        .appendField("获取动态配置项值");
    this.appendDummyInput()
        .appendField("动态配置类型")
        .appendField(new Blockly.FieldDropdown(TYPES),'types');
    this.appendValueInput("key")
        .appendField("动态配置项Key")
 ...
 * 数据源条件Map
 */
Blockly.Blocks['keys_map'] = {
  /**
   * Block for creating a list with any number of elements of any type.
   * @this Blockly.Block
   */
  init: function() {
    this.setHelpUrl('http://gitlab-sc.alibaba-inc.com/alidp/oneness/wikis/keys-map');
    this.setColour(KEYS_HUE);
    this.itemCount_ = 3;
    this.updateShape_();
